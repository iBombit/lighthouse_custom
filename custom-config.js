...
//      'network-gatherer',
  ...
  audits: [
    //'myCustom-audit',
	//'custom-network-audit',
	'MyNetworkRequests',
	'custom-network-server-latency',
	//'network-requests',
    'network-rtt',
    //'network-server-latency',
    'custom-main-thread-tasks',
    'metrics',
    'performance-budget',
    'timing-budget',
	'full-page-screenshot',
 ...
 groups: {
  ...
  categories: {
    'mysite': {
      ...
      description: 'Metrics for performance estimation',
      auditRefs: [
        ...
        {id: 'network-requests', weight: 1, group: 'metrics', acronym: 'NR', relevantAudits: m2a.myRelevantAudits},
        {id: 'network-rtt', weight: 0, group: 'metrics', acronym: 'RTT'},
        {id: 'network-server-latency', weight: 1, group: 'metrics', acronym: 'SBL', relevantAudits: m2a.myRelevantAudits},
        {id: 'main-thread-tasks', weight: 0, group: 'infos'},
        //{id: 'diagnostics', weight: 0, group: 'hidden'},
        //{id: 'metrics', weight: 0, group: 'hidden'},
        {id: 'screenshot-thumbnails', weight: 0, group: 'infos'},
		...
		{id: 'mainthread-work-breakdown', weight: 0, group: 'infos'},
      ],
    },
  },
};
