...
const HomePage = require('../pages/demoqa/homePage');
const TextBoxPage = require('../pages/demoqa/textBoxPage');
const UploadDownloadPage = require('../pages/demoqa/uploadDownloadPage');
const CheckBoxPage = require('../pages/demoqa/checkBoxPage');
const ButtonsPage = require('../pages/demoqa/buttonsPage');
