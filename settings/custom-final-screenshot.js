...
class CustomFinalScreenshot extends Audit {
    ...
    static get meta() {
        return {
            ...
            description: 'The last screenshot captured of the pageload. May not be accurate if loading time exceeds ~17sec.',
    ...
    static async audit(artifacts, context) {
        ...
        if (!finalScreenshot) {
            ...
            if (artifacts.GatherContext.gatherMode === 'timespan') return {
                notApplicable: true,
                score: 1
            };
