...
import {metricsToAudits} from './custom-metrics-to-audits.js';
...
const UIStrings = {
  ...
  serverSideCategoryTitle: 'Server-Side Metrics',
  serverSideCategoryDescription: 'API loading speed, Server-side latency and screenshot times. ',
};
...
const defaultConfig = {
  ...
  categories: {
    ...
    'server-side': {
      title: str_(UIStrings.serverSideCategoryTitle),
      description: 'Metrics for complete loading time',
      supportedModes: ['navigation', 'timespan'],
      auditRefs: [
          {id: 'network-requests', weight: 1, group: 'metrics', acronym: 'NR', relevantAudits: metricsToAudits.myRelevantAudits},
          {id: 'network-rtt', weight: 0, group: 'metrics', acronym: 'RTT'},
          {id: 'network-server-latency', weight: 1, group: 'metrics', acronym: 'SBL', relevantAudits: metricsToAudits.myRelevantAudits},
