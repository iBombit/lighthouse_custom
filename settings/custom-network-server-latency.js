...
const NetworkAnalysisComputed = require('lighthouse/lighthouse-core/computed/network-analysis.js');
...
class CustomNetworkServerLatency extends Audit {
    /**
    ...
    static async audit(artifacts, context) {
        ...
        return {
            ...
            displayValue: str_(i18n.UIStrings.ms, {
                timeInMs: maxLatency
            }),
...
module.exports = CustomNetworkServerLatency;
